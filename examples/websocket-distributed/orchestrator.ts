 ...
 *
 * To run this example:
 * 1. Start the orchestrator: bun run examples/websocket-distributed/orchestrator.ts
 * 2. Start workers in separate terminals: bun run examples/websocket-distributed/worker.ts
 */

import { SimpleOrchestrator } from "../../src/index.js";
