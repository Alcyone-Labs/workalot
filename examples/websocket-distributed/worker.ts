 ...
 *
 * To run this example:
 * 1. First start the orchestrator: bun run examples/websocket-distributed/orchestrator.ts
 * 2. Then start workers: bun run examples/websocket-distributed/worker.ts
