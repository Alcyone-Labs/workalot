...
export const BENCHMARK_CONFIGS: BenchmarkConfig[] = [
  ...
  // Redis Benchmarks (1k jobs)
  {
    name: "2-cores-1k-jobs-redis",
    cores: 2,
    totalJobs: 1000,
    taskTypes: DEFAULT_TASK_TYPES,
    backend: "redis",
  ...
  // Redis Benchmarks (10k jobs)
  {
    name: "2-cores-10k-jobs-redis",
    cores: 2,
    totalJobs: 10000,
    taskTypes: DEFAULT_TASK_TYPES,
    backend: "redis",
